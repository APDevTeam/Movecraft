...
public class Settings {
    ...
    public static boolean AllowContactsSigns = true;
    public static boolean AllowCrewSigns = true;
    public static boolean AllowCruiseSigns = true;
    public static boolean AllowDirectorSigns = true;
    public static boolean AllowHelmSigns = true;
    public static boolean AllowMoveSigns = true;
    public static boolean AllowNameSigns = true;
    public static boolean AllowPilotSigns = true;
    public static boolean AllowReleaseSigns = true;
    public static boolean AllowRemoteSigns = true;
    public static boolean AllowSpeedSigns = true;
    public static boolean AllowStatusSigns = true;
    public static boolean AllowSubcraftRotateSigns = true;
    public static boolean AllowTeleportSigns = true;
