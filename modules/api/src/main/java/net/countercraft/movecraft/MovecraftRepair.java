...
public abstract class MovecraftRepair {
    public abstract boolean saveCraftRepairState(Craft craft, Sign sign, String repairStateName);
    public abstract boolean saveRegionRepairState(World world, ProtectedRegion region);
    public abstract Clipboard loadCraftRepairStateClipboard(Craft craft, Sign sign, String repairStateName, World bukkitWorld);
