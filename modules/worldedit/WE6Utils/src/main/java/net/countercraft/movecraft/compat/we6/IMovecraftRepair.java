...
public class IMovecraftRepair extends MovecraftRepair {
    ...
    public boolean saveCraftRepairState (Craft craft, Sign sign) {
        ...
        File repairStateFile = new File(playerDir, sign.getLine(1) + ".schematic");
    ...
    public Clipboard loadCraftRepairStateClipboard(Craft craft, Sign sign) {
        ...
        Vector minPos = MathUtils.bukkitVectorFromWEVector(clipboard.getMinimumPoint());
        Vector distance = MathUtils.bukkitVectorFromWEVector(clipboard.getOrigin().subtract(clipboard.getMinimumPoint()));
        Vector size = MathUtils.bukkitVectorFromWEVector(clipboard.getDimensions());
