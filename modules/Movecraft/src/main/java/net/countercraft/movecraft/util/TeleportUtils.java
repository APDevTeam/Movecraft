...
public class TeleportUtils {
    ...
    static {
        ...
        try {
            ...
            Bukkit.getLogger().info("This is expected for 1.17 and up."); // TODO: Figure this out
            //e.printStackTrace();
        }
        intialized = sucess;
    }
    ...
    private static @NotNull Field getField(@NotNull Class<?> clazz, String name) throws NoSuchFieldException {
    ...
    private static @Nullable Object getHandle(Entity entity) {
        try {
