 ...
 */
@FunctionalInterface
public interface CraftSupplier extends QuadFunction<CraftType, World, Player, Collection<Craft>, Pair<Result, Craft>> {
    /**
     ...
     */
    @NotNull
    Pair<@NotNull Result, @Nullable Craft> apply(@NotNull CraftType type, @NotNull World w, @NotNull Player player, @NotNull Collection<Craft> parents);
}
