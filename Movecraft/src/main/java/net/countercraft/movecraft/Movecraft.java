 ...
 */
 ...
 import net.countercraft.movecraft.listener.DropListener;
 ...
 public class Movecraft extends JavaPlugin {
     ...
     private DropListener dropListener; // Add a field for DropListener
     ...
     public void onEnable() {
         ...
         dropListener = new DropListener(); // Instantiate DropListener
 
         // Register DropListener and pass it to InteractListener
         getServer().getPluginManager().registerEvents(dropListener, this);
 
         // Register InteractListener and pass DropListener reference
         getServer().getPluginManager().registerEvents(new InteractListener(dropListener), this);
